...
public class HabitosController {
    ...
    public ResponseEntity<HabitosDTOResponse> cadastroHabito(@RequestHeader("Authorization") String token, @Valid @RequestBody HabitosDTORequest dto){
        return ResponseEntity.status(HttpStatus.CREATED).body((habitosService.cadastraHabito(token, dto)));
    }
    ...
    @ApiResponse(responseCode = "401", description = "Usuário não autenticado")
    @ApiResponse(responseCode = "500", description = "Erro interno no servidor")
    public ResponseEntity<HabitosDTOResponse> alteraHabito (@RequestHeader("Authorization") String token, @Valid @RequestBody HabitosDTORequest dto,
                                                           @PathVariable String id){
    ...
    @ApiResponse(responseCode = "401", description = "Usuário não autenticado")
    @ApiResponse(responseCode = "500", description = "Erro interno no servidor")
    public ResponseEntity<List<CheckinDTOResponse>> historicoCheckin(@RequestHeader("Authorization") String token, @RequestParam String habitoId){
